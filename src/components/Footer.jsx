        ...
        <div className="flex flex-wrap gap-3 justify-center md:justify-start">
          ...
          >
            <svg className="w-4.5 h-4.5 fill-current" viewBox="0 0 24 24">
              <path d="M.057 24l1.687-6.163c-1.041-1.804-1.588-3.849-1.587-5.946C.06 5.348 5.397.01 12.008.01c3.202.001 6.212 1.25 8.477 3.517 2.266 2.268 3.51 5.28 3.51 8.484-.004 6.657-5.34 11.997-11.953 11.997-2.005-.001-3.973-.502-5.724-1.455L0 24zm6.59-4.846c1.6.95 3.488 1.459 5.407 1.46h.007c5.626 0 10.204-4.579 10.207-10.205.002-2.726-1.059-5.289-2.987-7.217-1.928-1.929-4.488-2.99-7.218-2.993-5.631 0-10.21 4.579-10.213 10.206-.001 1.923.504 3.799 1.463 5.407L1.93 22.07l4.716-1.238zm13.116-7.25c-.24-.12-1.424-.702-1.647-.783-.223-.08-.386-.12-.55.12-.162.24-.63.783-.772.943-.143.16-.285.18-.525.06-.24-.12-.16-.27-.475-.55-.49-.437-.96-.868-1.32-1.487-.142-.24-.015-.369.105-.489.108-.108.24-.28.36-.42.12-.14.16-.24.24-.4.08-.16.04-.3-.02-.42-.06-.12-.55-1.326-.75-1.812-.197-.474-.396-.407-.55-.415-.143-.007-.306-.008-.47-.008-.165 0-.432.062-.657.308-.225.246-.86.84-8.6 2.05.002 1.21.785 2.38.895 2.53.11.15 1.543 2.355 3.74 3.303.52.224.927.359 1.244.46.52.165 1.0.142 1.375.085.42-.063 1.29-.527 1.475-1.036.185-.509.185-.944.13-1.037-.05-.09-.2-.145-.44-.265z" />
            </svg>
          </a>
          <a
